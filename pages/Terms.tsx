        ...
        <div className="space-y-10 text-slate-700 leading-relaxed font-light">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-4 space-y-2">
              ...
              <li><strong>No Rescheduling:</strong> Due to the limited nature of our availability, sessions cannot be rescheduled after a missed appointment.</li>
          ...
          <section>
            ...
            <p>
              Fees paid for consultations are non-refundable once the service has been delivered. Cancellation requests must be made at least 24 hours prior to the appointment to be eligible for a credit toward a future session. No refunds are provided for missed appointments.
            </p>
          </section>
